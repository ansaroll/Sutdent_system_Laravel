...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <p class="card-text">You can find here all the informations about students in our system.</p>
          ...
          @foreach($students as $tudent)
            ...
            <tr>
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-10 w-10">
                    <img class="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1494790108378-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60" alt="">
                  </div>
                  <div class="ml-4">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                ...
                <a href="{{ url('/destroy/'.$tudent->id ) }}" class="btn btn-danger">Delete</a>
